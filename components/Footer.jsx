  ...
  return (
    <Box
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 5 }} spacing={8}>
          ...
          <Stack bg={"white"} width={"100%"} p={"10px 40px"}>
               ...
               <Text color={"gray.900"} textAlign={"center"}>EXCLUSIVE NEWS</Text>
               <Text color={"gray.900"} fontSize={"10px"}>Sign up for the newsletter
                and discover the latest arrivals and promotions</Text>

                <Input bg={"#eceef1"}  borderRadius="none"  mt="1rem" placeholder='INSERT EMAIL'
                 fontSize={{base:"0.7rem",sm:"0.8rem",md:"0.9rem"}} 
                 paddingLeft={"10px"} size='md' h="40px" fontWeight={400} />
                <Flex gap={"15px"}>
                  <Checkbox color={"black"}/>
                  <Text fontSize={"8px"} color={"gray.300"}>I consent to receive EXCLUSIVE newsletters via email. For further information, please consult the Privacy Policy.</Text>
                </Flex>
                <Button colorScheme='grey' borderRadius={'none'} w={"100%"} mt="1rem" bg={"gray.900"} color="white">SIGN UP</Button>
          </Stack>
          <Stack align={'flex-start'}>
      ...
      <Box py={10}>
        ...
        <SimpleGrid columns={{ base: 1, sm: 1, md: 2 }} mt={{ base: 10, sm: 10, md: 0 }} ml={{ base: 10, sm: 10, md: "100px" }} spacing={8}>
        <Stack marginLeft={"50px"} >
          <Flex alignItems={"center"}>
            <Box>
            <Text>Connect with us</Text>
            </Box>
            <Flex  gap={"16px"} fontSize="30px" marginLeft={"50px"}>
            <FaTwitter />
            <FaYoutube />
            <FaInstagram />
            </Flex>
        ...
        <Flex gap={"16px"}>
          ...
          <Box>
              <Text>DOWNLOAD THE APP FOR iOS / ANDROID</Text>
          </Box>
        </Flex>
        </SimpleGrid>
      </Box>
      <Box w={"100%"} border={"1px"} h={"100px"} bg={"gray.900"} textAlign={"center"}>
               <Text fontSize={{base: "xs", sm: "xs", md: "sm" }} mt={"40px"} color={"white"}>
                POWERED BY EXCLUSIVE NET-A-PORTER GROUP - COPYRIGHT © 2000-2022 YOOX NET-A-PORTER GROUP S.P.A. - ALL RIGHTS RESERVED - SIAE LICENCE # 401/I/526
                </Text>
      </Box>
    </Box>
  );
