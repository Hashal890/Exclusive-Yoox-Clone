    ...
    >
      <Container as={Stack} maxW={"6xl"} py={10}>
        ...
        >
          ...
          >
            ...
            <Text color={"gray.900"} fontSize={"10px"}>
            ...
            <Flex gap={"15px"}>
              ...
              <Text fontSize={"8px"} color={"gray.300"}>
                I consent to receive EXCLUSIVE newsletters via email. For further information,
      ...
      <Box w={"100%"} border={"1px"} h={"100px"} bg={"gray.900"} textAlign={"center"}>
        <Text fontSize={{ base: "xs", sm: "xs", md: "sm" }} mt={"40px"} color={"white"}>
          POWERED BY EXCLUSIVE NET-A-PORTER GROUP - COPYRIGHT © 2000-2022 YOOX NET-A-PORTER GROUP
          S.P.A. - ALL RIGHTS RESERVED - SIAE LICENCE # 401/I/526
        </Text>
      </Box>
    </Box>
  );
