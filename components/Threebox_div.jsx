  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Img style={{ height: "100%", width: "100%" }} src={box_1_images} alt="" />

          <Text fontWeight={"1000"} textAlign="center" mt={"20px"}>
            {text_box_1}
          </Text>
          <Text mt={"30px"} textDecoration={"underline"} fontWeight={"200"} textAlign="center">
            SHOP NOW
          </Text>
        </Box>
        ...
        >
          {ulListed == "true" ? (
            <UnorderedList
              ...
              fontWeight={700}
            >
              <ListItem color={"grey"} fontWeight={300}>
                {" "}
                DESIGNER
              </ListItem>
        ...
        <Box
          ...
          h={{ base: "70%", sm: "70%", md: "90%" }}
        >
          <Img style={{ height: "100%", width: "100%" }} src={box_2_images} alt="" />

          <Text fontWeight={"1000"} mt={"20px"} textAlign="center">
            {text_2_}
          </Text>
          <Text mt={"30px"} textDecoration={"underline"} fontWeight={"200"} textAlign="center">
            SHOP NOW
