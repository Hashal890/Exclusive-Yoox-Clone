...
<Image margin={"auto"} h={{base: "100", sm: "140", md: "140px"}} w={{base: "120", sm: "180", md: "180px"}} src="https://www.psdstamps.com/wp-content/uploads/2022/04/grunge-exclusive-label-png.png"/>
<Text fontWeight={"bolder"} mt={"-2rem"} fontSize={{base: "xs", sm: "xs", md: "sm"}} textAlign={"center"}>SHOP FASHION / DESIGN+ART</Text>
</Box>
</Stack>
...
<Box textAlign={"center"}  padding={"2rem 0rem"} backgroundColor={"gray.900"} color={"white"}>
  <Text>{item.name}</Text>
</Box>
